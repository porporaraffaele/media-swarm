...
content_ideation_team = Team(
    ...
    instructions=[
        ...
        "- Use trend data from the News Team to inform timely content ideas.",
        "- Reference the Branding Team's tone of voice when setting content tone.",
        "- Your content plans feed into: Content Creator (visual production),",
        "  Copywriting (text creation), and Web/Blog (editorial calendar).",
        "- Coordinate with the Community Team for engagement-driven content.",
        "- Use audience insights from the Competitors Team for targeting.",
    ],
