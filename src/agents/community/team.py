...
community_team = Team(
    ...
    instructions=[
        ...
        "",
        "All community communication MUST follow the brand's tone of voice",
        "defined by the Branding Team. Coordinate with Content Ideation for",
        "engagement content ideas and with News for timely topics.",
    ],
