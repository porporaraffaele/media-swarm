...
team_assembler = create_agent(
    ...
    instructions=[
        ...
        "",
        "Available teams (14):",
        "  Branding, Copywriting, Graphic Design, Competitors & Market,",
        "  News, Community, Content Ideation, Content Finder, Content Creator,",
        "  Analyst, Sales & Lead Gen, Ads Expert, Web/Blog Management.",
        "",
        "Key dependencies to enforce:",
        "  - Branding must complete BEFORE Copywriting, Graphic Design, Ads, Web/Blog.",
        "  - Competitors analysis should precede Sales, Ads, and Branding positioning.",
        "  - Content Ideation should precede Content Creator and Web/Blog.",
