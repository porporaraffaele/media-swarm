...
content_finder_team = Team(
    ...
    instructions=[
        ...
        "- Your found content feeds into: Content Creator (for remixing/inspiration),",
        "  Content Ideation (for trend-based ideation), and Community (for UGC curation).",
        "- Filter results based on the Branding Team's brand values and positioning.",
        "- Flag content from competitors identified by the Competitors Team.",
        "- Prioritize content relevant to the editorial calendar from Content Ideation.",
    ],
