...
content_creator_team = Team(
    ...
    instructions=[
        ...
        "- ALWAYS follow the Branding Team's visual identity: colors, typography,",
        "  logo placement, and style guidelines. Visual content must be on-brand.",
        "- Use briefs from Content Ideation for what to create.",
        "- Use copy from the Copywriting Team for text overlays and captions.",
        "- Your visual assets serve: Ads Expert (ad creatives), Community (social posts),",
        "  Web/Blog (article imagery), and Graphic Design (brand collateral).",
    ],
