...
ads_expert_team = Team(
    ...
    instructions=[
        ...
        "- Ad creatives MUST respect the Branding Team's visual identity and tone of voice.",
        "- Use ad copy from the Copywriting Team's Ad Copy Specialist for consistency.",
        "- Leverage audience segments from the Competitors Team's analysis.",
        "- Coordinate with the Sales Team for lead generation campaign goals.",
        "- Use the Content Creator Team for producing visual ad assets.",
        "- Landing pages should be coordinated with the Web/Blog Team.",
    ],
