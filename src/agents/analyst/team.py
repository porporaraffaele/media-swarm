...
analyst_team = Team(
    ...
    instructions=[
        ...
        "9. Production Monitor sends briefings and reminders via Telegram.",
        "",
        ...
        "The Production Monitor can proactively notify the user of urgent findings.",
        "",
        "CROSS-TEAM EVALUATION SCOPE:",
        "- You evaluate ALL 13 domain teams: Branding, Copywriting, Graphic Design,",
        "  Competitors, News, Community, Content Ideation, Content Finder,",
        "  Content Creator, Sales, Ads Expert, Web/Blog, and the Master Orchestrator.",
        "- Assess inter-team collaboration quality: are teams sharing context effectively?",
        "- Monitor brand consistency across all content-producing teams.",
        "- Track cost efficiency across all LLM-powered operations.",
        "- Your improvement suggestions loop back to the Master Orchestrator for action.",
    ],
