...
-- Add 'loaded' and 'docx' and 'csv' to allowed source types
...
-- Projects: group team runs under a named project
...
-- Project sessions: track all interactions under a project
...
CREATE INDEX idx_project_sessions_created ON project_sessions(created_at);
